        ...
        <div class="su-content">
            ...
            <div class="su-details">
                ...
                <!-- <div class="su-terms">
                    ...
                    <div class="su-txt">Check the box in<a href="#" onclick="myFunction()" id="myBtn">Terms &
                            Conditions</a> before signing up.</div>
                </div> -->
                <div class="su-button">
                ...
                <!-- <div id="ModalTerms" class="modalterms">
                    <div class="terms-content">
                        <a href="#bottom" class="bottompg" id="pgbottom"><img class="bottomimg" src="icons/bottom.png"
                                alt=""></a>
                        <h2 class="termsTtl"><b>TERMS AND CONDITIONS</b></h2>
                        <p>1. <b>Introduction</b></p>
                        <p>Welcome to <b>Envirotech</b> (“Company”, “we”, “our”, “us”)!</p>
                        <p>These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located
                            at <b>www.resiklo.com</b> (together or individually “Service”) operated by
                            <b>Envirotech</b>.
                        </p>
                        ...
                        <p>If you do not agree with (or cannot comply with) Agreements, then you may not use the
                            Service, but please let us know by emailing at <b>info@envirotech.com.ph</b> so we can try
                            to find a solution. These Terms apply to all visitors, users and others who wish to access
                            or use Service.</p>
                        <p>2. <b>Communications</b></p>
                        <p>By using our Service, you agree to subscribe to newsletters, marketing or promotional
                        ...
                        <p>5. <b>Refunds</b></p>
                        <p>We issue refunds for Contracts within <b>7 days</b> of the original purchase of the Contract.
                        </p>
                        <p>6. <b>Content</b></p>
                        <p>Content found on or through this Service are the property of Envirotech or used with
                        ...
                        <p>You may use Service only for lawful purposes and in accordance with Terms. You agree not to
                            use Service:</p>
                        <p>0.1. In any way that violates any applicable national or international law or regulation.</p>
                        <p>0.2. For the purpose of exploiting, harming, or attempting to exploit or harm minors in any
                            way by exposing them to inappropriate content or otherwise.</p>
                        <p>0.3. To transmit, or procure the sending of, any advertising or promotional material,
                            including any “junk mail”, “chain letter,” “spam,” or any other similar solicitation.</p>
                        <p>0.4. To impersonate or attempt to impersonate Company, a Company employee, another user, or
                        ...
                        <p>0.2. Use any robot, spider, or other automatic device, process, or means to access Service
                            for any purpose, including monitoring or copying any of the material on Service.</p>
                        <p>0.3. Use any manual process to monitor or copy any of the material on Service or for any
                        ...
                        <p>Service is intended only for access and use by individuals at least eighteen (18) years old.
                            ...
                            years old, you are prohibited from both the access and usage of Service.</p>
                        <p>10. <b>Accounts</b></p>
                        ...
                        <p>Service and its original content (excluding Content provided by users), features and
                            functionality are and will remain the exclusive property of Envirotech and its licensors.
                            ...
                            written consent of Envirotech.</p>
                        ...
                        <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the
                            ...
                            submit your claim via email to info@envirotech.com.ph, with the subject line: “Copyright
                            Infringement” and include in your claim a detailed description of the alleged Infringement
                            as detailed below, under “DMCA Notice and Procedure for Copyright Infringement Claims”</p>
                        <p>You may be held accountable for damages (including costs and attorneys’ fees) for
                            ...
                            through Service on your copyright.</p>
                        ...
                        <p>0.1. an electronic or physical signature of the person authorized to act on behalf of the
                            owner of the copyright’s interest;</p>
                        <p>0.2. a description of the copyrighted work that you claim has been infringed, including the
                        ...
                        <p>0.3. identification of the URL or other specific location on Service where the material that
                            you claim is infringing is located;</p>
                        ...
                        <p>You can contact our Copyright Agent via email at info@envirotech.com.ph.</p>
                        <p>14. <b>Error Reporting and Feedback</b></p>
                        <p>You may provide us either directly at info@envirotech.com.ph or via third party sites and
                            ...
                            and agree that: (i) you shall not retain, acquire or assert any intellectual property right
                            or other right, title or interest in or to the Feedback; (ii) Company may have development
                        ...
                        <p>Our Service may contain links to third party web sites or services that are not owned or
                            controlled by Envirotech.</p>
                        <p>Envirotech has no control over, and assumes no responsibility for the content, privacy
                        ...
                        <p>THESE SERVICES ARE PROVIDED BY COMPANY ON AN “AS IS” AND “AS AVAILABLE” BASIS. COMPANY MAKES
                            NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF
                            THEIR SERVICES, OR THE INFORMATION, CONTENT OR MATERIALS INCLUDED THEREIN. YOU EXPRESSLY
                            AGREE THAT YOUR USE OF THESE SERVICES, THEIR CONTENT, AND ANY SERVICES OR ITEMS OBTAINED
                            FROM US IS AT YOUR SOLE RISK.</p>
                        ...
                        <p>COMPANY HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, STATUTORY,
                        ...
                        <p>We reserve the right to withdraw or amend our Service, and any service or material we provide
                            ...
                            all or any part of Service is unavailable at any time or for any period. From time to time,
                            we may restrict access to some parts of Service, or the entire Service, to users, including
                            registered users.</p>
                        ...
                        <p>Your continued use of the Platform following the posting of revised Terms means that you
                        ...
                        <p>If any provision of Terms is held by a court or other tribunal of competent jurisdiction to
                        ...
                        <p>Please send your feedback, comments, requests for technical support by email:
                            <b>info@envirotech.com.ph</b>.
                        </p>
                        <div class="containerTerms">
                            <input type="checkbox" id="terms" class="terms" value="true">
                            <div class="su-txt">By signing up, I agree to all the Terms and Conditions of Envirotech
                            </div>
                        </div>
                        <button type="button" id="confirmbtn" class="termsTtl">Confirm</button>
            ...
            <!-- <script>
                ...
                var term = document.querySelector('#terms').checked;
                ...
                modal.onscroll = function () {
                    var bottom = modal.getBoundingClientRect().bottom;
                    var left = window.pageYOffset;
                    var x = document.getElementsByClassName("bottompg");
                    var y = document.getElementById("pgbottom");
                    console.log(left)
